...
if __name__ == "__main__":
    ...
    wavfile_list_train = GenWavList('data/train/wav.scp')
    wavfile_list_test  = GenWavList('data/test/wav.scp')
    ...
    preprocess(wavfile_list_train, args.out_dir+'/'+'train', cqt_conf, num_workers)

    print("Preprocess test data ...")
    preprocess(wavfile_list_test, args.out_dir+'/'+'test', cqt_conf, num_workers)
