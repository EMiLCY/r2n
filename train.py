...
def main(run_id, pretrained, data_files, model_params, training_params, device):
    ...
    for epoch in range(start_epoch, start_epoch+epochs):
        ...
        acc1 = validate.validate(train_loader, model, device, log_interval)    
...
if __name__ == '__main__':
    ...
    parser.add_argument('--run-id', action='store', type=str, default='SEResNet34cqt1')
    ...
    parser.add_argument('--configfile', action='store', type=str,default='conf/training_mdl/seresnet34.json')
